...
def train(model, data,
    ...
    with tf.device(device_str):
        ...
        opt = tf.contrib.layers.optimize_loss(loss, global_step, learning_rate, 'Adam',  # ! global_step is a variable that count steps
    ...
    ema_op = ema.apply([loss, accuracy] + tf.trainable_variables()) # compute the moving average of (...), and stored in ema.average()
